alter table dba.bs_config  add
       char_corrimiento_tipo_peso numeric(3,0) null,
       char_corrimiento_unidad numeric(3,0) null,
       char_corrimiento_peso numeric(3,0) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'char_corrimiento_tipo_peso', 39,
        'Char Corrimiento Tipo Peso:', 0 ,
        'Char Corrimiento Tipo Peso', 0,
       24 , '[General]',
       0 , 65 , 142 ,
        '', 'N',
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'bs_config',
        object_id('dba.bs_config'),
        'dba',  'char_corrimiento_unidad', 40,
        'Char Corrimiento Unidad:', 0 ,
        'Char Corrimiento Unidad', 0,
       24 , '[General]',
       0 , 65 , 142 ,
        '', 'N',
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'bs_config',
        object_id('dba.bs_config'),
        'dba',  'char_corrimiento_peso', 41,
        'Char Corrimiento Peso:', 0 ,
        'Char Corrimiento Peso', 0,
       24 , '[General]',
       0 , 65 , 142 ,
        '', 'N',
