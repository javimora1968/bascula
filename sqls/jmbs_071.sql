alter table dba.bs_config  add
       ind_liq_x_config_vehiculo char(1) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'ind_liq_x_config_vehiculo', 26,
        'Ind Liq X Config Vehiculo:', 0 ,
        'Ind Liq X Config Vehiculo', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
        '',
        'para definir si se liquidan los pesajes en función de la configuracion del vehiculo',
        '', '');
