alter table dba.bs_config_vehiculos  add
       item_facturacion_nocturno char(15) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.bs_config_vehiculos');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'bs_config_vehiculos',
        object_id('dba.bs_config_vehiculos'),
        'dba',  'item_facturacion_nocturno', 10,
        'Item Facturacion Nocturno:', 0 ,
        'Item Facturacion Nocturno', 0,
       23 , '',
       0 , 65 , 325 ,
        '', 'N',
