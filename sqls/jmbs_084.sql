alter table dba.bs_config  add
       ind_zona_f_tiquetes_igual char(1) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'ind_zona_f_tiquetes_igual', 27,
        'Ind Zona F Tiquetes Igual:', 0 ,
        'Ind Zona F Tiquetes Igual', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
        '',
        'Para definir si la zona de facturacion de pesajes (donde aplique) se toma igual a la de los consecutivos de tiq
uetes o la debe tomar de esta tabla de configuracion ',
        '', '');
