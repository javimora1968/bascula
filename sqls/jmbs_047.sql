create table dba.bs_config_vehiculos
       (id_empresa char(15) not null,
       id_tipo char(15) not null,
       descripcion varchar(100) not null,
       peso_maximo numeric(8,0) not null,
       tipo_vehiculo char(15) not null,
       id_usuario char(15) not null,
       fec_registro datetime not null);

alter table dba.bs_config_vehiculos
       add constraint pk_bs_config_vehiculos primary key  nonclustered
       (id_empresa,
       id_tipo);
