alter table dba.bs_config  add
       dias_plazo_facturas_pesaje numeric(18,0) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'dias_plazo_facturas_pesaje', 28,
        'Dias Plazo Facturas Pesaje:', 0 ,
        'Dias Plazo Facturas Pesaje', 0,
       24 , '[General]',
       0 , 65 , 421 ,
        '', 'N',
        '',
        'Para definir cuantos dias de plazo se conceden cuando se facturen pesajes a crédito',
        '', '');
