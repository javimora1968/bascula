create table dba.bs_analisis_item
       (id_empresa char(2) not null,
       tipo_doc char(2) not null,
       n_doc numeric(6,0) not null,
       id_item char(15) not null,
       caracteristica char(5) not null,
       unidad char(2) not null,
       valor varchar(200) not null,
       valor1_numerico numeric(8,2) not null,
       valor2_numerico numeric(8,2) not null,
       valor_booleano char(1) not null,
